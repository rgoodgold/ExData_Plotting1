...
## Top right
with(data_subset, plot(y = Voltage, x=datetime, type = "n" )) 
with(data_subset, lines(y = Voltage, x=datetime, col="black")) 

## Bottom right
with(data_subset, plot(y = Global_reactive_power, x = datetime, type = "n")) 
with(data_subset, lines(y=Global_reactive_power, x = datetime, col = "black")) 
